...
const allUpperCase = (arr) => {
  ...
  let newAllArrays = [];
  arr.forEach((z) => {
    newAllArrays.push(z.toUpperCase());
  });
  return newAllArrays;
};
...
const fizzbuzz = (arr) => {
  ...
  arr.forEach((z) => {
    if (z % 3 === 0 && z % 5 === 0) {
      newAllArrays.push("Fizz Buzz");
    } 
    else if (z % 5 === 0) {
      newAllArrays.push("Buzz");
    } 
    else if (z % 3 === 0) {
      newAllArrays.push("Fizz");
    } 
    else {
      newAllArrays.push(z);
    }
