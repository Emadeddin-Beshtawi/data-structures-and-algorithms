...
const toLastNames = (people) => {
  ...
  let allArray = [];
  people.map((z) => {
    allArray.push(`${z.firstName} ${z.lastName}`);
  });
  return allArray;
};
...
const addValues = (arr) => {
  // Solution code here...
  return arr.reduce((z, value) => z + value, 0);
};
...
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce((z, value) => z + value.purchasePrice, 0);
};
...
const returnNames = (arr) => {
  // Solution code here...
  return arr.reduce((z, value, index) => {
    z[index] = value.name;
    return z;
  }, []);
};
...
const reversedString = (str) => {
  // Solution code here...
  return str.split('').reduce((x1, x2) => x2 + x1, '');
};
